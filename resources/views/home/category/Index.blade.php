                    ...
                    @foreach($products as $re)
                        <div class="no-margin carousel-item product-item-holder hover size-medium">
                            <div class="product-item">
                                ...
                                @endif
                                <div class="image">
                                    <a href="{{url('product/detail')}}/{{$re->productid}}"><img alt="" src="{{$re->cover}}" data-echo="{{$re->cover}}"/></a>
                    ...
                    <div class="control-bar">
                        <div id="popularity-sort" class="le-select">
                            <select data-placeholder="sort by popularity">
                                <option value="1">1-100 元</option>
                                <option value="2">101-200 元</option>
                        ...
                        <div id="item-count" class="le-select">
                            <select>
                                <option value="1">24 页</option>
                                <option value="2">48 页</option>
                                <option value="3">32 页</option>
                            </select>
                        </div>
