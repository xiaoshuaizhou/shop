                ...
                <div class="row no-margin cart-item">
                    <div class="col-xs-12 col-sm-2 no-margin">
                        <a href="#" class="thumb-holder">
                            <img class="lazy" alt="" src="{{$product->product->cover}}" />
                        </a>
                    </div>

                    <div class="col-xs-12 col-sm-5 ">
                        <div class="title">
                            <a href="{{url('product/detail/')}}/{{$product->product->productid}}">{{$product->product->title}}</a>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 no-margin">
                        ...
                        <div class="quantity">
                            <div class="le-quantity">
                                ...
                                <input  readonly="readonly" id="{{$product->cartid}}" name="productnum" type="text" value="{{$product->productnum}}" />
                    ...
                    <div class="col-xs-12 col-sm-2 no-margin">
                        <div class="price">
                            {{$product->productnum * $product->price}}
                        </div>
                        <a class="close-btn" href="{{url('cart/del', ['cartid' => $product->cartid])}}"></a>
                    </div>
                </div><!-- /.cart-item -->
                @endforeach
                ...
                <div class="widget cart-summary">
                    ...
                    <div class="body">
                        <ul class="tabled-data no-border inverse-bold">
                            ...
                            <li>
                                <label>购物车宝贝种类</label>
                                <div class="value pull-right">{{$data->count('productid')}}</div>
                            </li>
                        </ul>
                    ...
                    <div class="body">
                        <form>
                            <div class="inline-input">
                                <input data-placeholder="输入优惠券码" type="text" />
