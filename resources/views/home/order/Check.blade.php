        ...
        <div class="container">
            <div class="col-xs-12 no-margin">
                            ...
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    <input class="le-radio big address" type="radio" name="address"
                                           value="{{$add->addressid}}" @if ($key == 0)  checked = "checked" @endif />
                                    ...
                                    <a class="btn btn-warning btn-sm"  href="{{url('address/edit', ['addressid' => $add['addressid']])}}">编辑</a> |
                                    <a class="btn btn-danger btn-sm" href="{{url('address/del', ['addressid' => $add['addressid']])}}">删除</a>
                                </div>
                            </div>
                        </div><!-- /.field-row -->
                    @endforeach
                    ...
                    <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                        <div id="subtotal-holder">
                                ...
                                <li>
                                    ...
                                    <div class="value">
                                        ...
                                        @foreach($express as $exp)
                                            <input class="le-radio express" type="radio" name="expressid" value="{{$exp['expressprice']}}" >{{$exp['expressname']}}
                            ...
                            <ul id="total-field" class="tabled-data inverse-bold ">
                                <li>
                                    <label>订单总计</label>
                                    <div class="value">{{$totalPrice}}&nbsp;元</div>
                                </li>
                            </ul><!-- /.tabled-data -->
                        ...
                        <div class="payment-method-option">
                            ...
                            <div class="radio-label bold ">Direct Bank Transfer<br>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Fusce rutrum tempus elit, vestibulum vestibulum erat ornare id.</p>
                            </div>
                ...
                <div class="place-order-button">
                    <button class="le-button big">创建订单</button>
