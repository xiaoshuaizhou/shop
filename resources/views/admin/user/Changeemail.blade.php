            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        <form class="new_user_form inline-input" role="form" method="POST" action="{{ url('/admin/manager/changeemailpost') }}" >
                            @csrf
                            ...
                            <div class="span12 field-box{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" class="span9" name="email" value="{{ $user->email }}">
