        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        <form class="new_user_form inline-input" action="{{url('admin/category/update')}}" method="post"/>
                        @csrf
                        <input type="hidden" name="cateid" value="{{$cat->cateid}}">
                        <div class="span12 field-box">
                            ...
                            <div class="ui-select span5">
                                <select name="parent_id">
                                    ...
                                    @foreach($cats as $c)
                                        <option @if($cat->parent_id == $c->cateid) selected="selected"  @endif value="{{$c->cateid}}" />{{$c->title}}
                                    @endforeach
                                </select>
                        ...
                        <div class="span12 field-box">
                            <label>分类名称:</label>
                            <input class="span9" name="title" type="text" value="{{ $cat->title }}" />
                            @if ($errors->has('title'))
                                <span class="invalid-feedback error">
