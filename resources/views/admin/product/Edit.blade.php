            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
                    ...
                    @csrf
                        ...
                        <input type="hidden" name="tupian" value="{{$product->pics}}">
                    <div class="field-box">
                        <label>商品分类:</label>
                        <div class="ui-select">
                            <select name="cateid">
                                @foreach($cats as $cat)
                                <option
                                @if($product->cateid == $cat->cateid) selected="selected"  @endif
                                        value="{{$cat->cateid}}"
                                />{{$cat->title}}
                                @endforeach
                            </select>
                    ...
                    <div class="field-box">
                        <label>商品名称</label>
                        <input class="span8" name="title" type="text" value="{{$product->title}}" />
                        @if ($errors->has('title'))
                    ...
                    <div class="field-box">
                        ...
                        <div class="wysi-column span10">
                            <textarea id="wysi" name="descr" class="span8 wysihtml5" rows="5">{{$product->descr}}</textarea>
                            @if ($errors->has('descr'))
                                <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        <label>商品价格</label>
                        <input class="span8" name="price" type="text" value="{{$product->price}}" />
                        @if ($errors->has('price'))
                            <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        ...
                        <div class="span8">
                            <label class="radio">
                                <input type="radio" name="ishot" id="optionsRadios1" value="1" checked="true" />
                                是
                            </label>
                            <label class="radio">
                        ...
                        @elseif($product->ishot == 0)
                            <div class="span8">
                                <label class="radio">
                                    <input type="radio" name="ishot" id="optionsRadios1" value="1"  />
                                    是
                                </label>
                                <label class="radio">
                                    <input type="radio" name="ishot" id="optionsRadios2" value="0" checked="true"/>
                                    否
                                </label>
                                @if ($errors->has('ishot'))
                                    <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        ...
                        <div class="span8">
                            <label class="radio">
                                <input type="radio" name="issale" id="optionsRadios1" value="1" checked="true" />
                                是
                            </label>
                            <label class="radio">
                        ...
                        <div class="span8">
                            <label class="radio">
                                <input type="radio" name="issale" id="optionsRadios1" value="1" />
                                是
                            </label>
                            <label class="radio">
                                <input type="radio" name="issale" id="optionsRadios2" value="0" checked="true"/>
                                否
                            </label>
                            @if ($errors->has('issale'))
                                <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        <label>促销价格</label>
                        <input class="span8" name="saleprice" type="text" value="{{$product->saleprice}}" />
                    ...
                    <div class="field-box">
                        <label>库存</label>
                        <input class="span8" name="num" type="text"  value="{{$product->num}}"/>
                        @if ($errors->has('num'))
                            <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        ...
                        <div class="span8">
                            <label class="radio">
                                <input type="radio" name="ison" id="optionsRadios1" value="1" checked="true" />
                                是
                            </label>
                            <label class="radio">
                            ...
                            <div class="span8">
                                <label class="radio">
                                    <input type="radio" name="ison" id="optionsRadios1" value="1"  />
                                    是
                                </label>
                                <label class="radio">
                                    <input type="radio" name="ison" id="optionsRadios2" value="0" checked="true"/>
                                    否
                                </label>
                                @if ($errors->has('ison'))
                                    <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        ...
                        <div class="span8">
                            <label class="radio">
                                <input type="radio" name="istui" id="optionsRadios1" value="1" checked="true"  />
                                是
                            </label>
                            <label class="radio">
                            ...
                            <div class="span8">
                                <label class="radio">
                                    <input type="radio" name="istui" id="optionsRadios1" value="1"  />
                                    是
                                </label>
                                <label class="radio">
                                    <input type="radio" name="istui" id="optionsRadios2" value="0" checked="true" />
                                    否
                                </label>
                                @if ($errors->has('istui'))
                                    <span class="invalid-feedback error">
                    ...
                    <div class="field-box">
                        ...
                        <div class="span3 avatar-box">
                            <div class="personal-image">
                                <img src="{{$product->cover}}" class="avatar img-circle" />
                ...
                @foreach(json_decode($product->pics, true) as $k => $pic)
                    <div class="field-box">
                        <label>商品图片:</label>
                ...
                @endforeach
                    ...
                    <div class="span11 field-box actions">
                        <input type="submit" class="btn btn-primary" value="修改商品" />
                        <span>或者</span>
                    ...
                    @elseif (count($errors->success) > 0)
                        <div class="alert alert-success span10 inline-input">
                            <ul style="color:green; text-align: center;">
                                <ol style="text-align: center;">修改成功</ol>
                            </ul>
                        </div>
                    @endif
                </div>
